Feature: desenvolver cenarios de avaliacao de notas de um pesquisador em relacao a um conjunto de qualis escolhido
  ...
  Scenario: busca de notas por pesquisador e um qualis
    Given eu estou na pagina de avaliacao de notas e a pesquisadora "AnjolinaGrisi" e o qualis "2015" estao cadastrados
    When eu seleciono a pesquisadora cadastrada "AnjolinaGrisi" e o qualis "2015"
    Then eh mostrado na tela uma lista com a quantidade de publicacoes que a pesquisadora "AnjolinaGrisi" tem por nota no qualis de "2015"
